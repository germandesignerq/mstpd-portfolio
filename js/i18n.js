...
(() => {
  ...
  const RU = {
    ...
    "d.producer": "Продюсеры",
    "d.producer_ph": "Имя и фамилия",
    "d.producer_add": "Добавить продюсера",
    "d.producer_hint": "Все, кто сделал бит — попадут в credits релиза.",
    "d.genre": "Жанр",
    ...
    "d.audio": "Аудио трека",
    "d.audio_hint": "WAV, 16 или 24 бит, 44.1 или 48&nbsp;кГц — то, что просят площадки; здесь не проверяется. До 28&nbsp;МБ.",
    "d.cover": "Обложка трека",
    "d.cover_hint": "JPEG, 1440×1440 или 3000×3000&nbsp;px — то, что просят площадки; здесь не проверяется. До 4&nbsp;МБ.",
  ...
  const UK = {
    ...
    "d.producer": "Продюсери",
    "d.producer_ph": "Ім'я та прізвище",
    "d.producer_add": "Додати продюсера",
    "d.producer_hint": "Усі, хто зробив біт — потраплять у credits релізу.",
    "d.genre": "Жанр",
    "d.genre_ph": "напр. Hip-Hop",
    "d.subgenre": "Піджанр",
    "d.subgenre_ph": "напр. Trap",
    ...
    "d.audio": "Аудіо треку",
    "d.audio_hint": "WAV, 16 або 24 біт, 44.1 або 48&nbsp;кГц — те, що просять майданчики; тут не перевіряється. До 28&nbsp;МБ.",
    "d.cover": "Обкладинка треку",
    "d.cover_hint": "JPEG, 1440×1440 або 3000×3000&nbsp;px — те, що просять майданчики; тут не перевіряється. До 4&nbsp;МБ.",
