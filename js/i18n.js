...
(() => {
  ...
  const RU = {
    ...
    "d.audio": "Аудио трека",
    "d.audio_ph": "https://we.tl/… или drive.google.com/…",
    "d.audio_hint": "WAV 16 или 24 бит, 44.1 или 48&nbsp;кГц. Загрузите на WeTransfer, Google Drive или Dropbox и вставьте ссылку — файл такого размера не пройдёт как вложение в письме.",
  ...
  const UK = {
    ...
    "d.audio": "Аудіо треку",
    "d.audio_ph": "https://we.tl/… або drive.google.com/…",
    "d.audio_hint": "WAV 16 або 24 біт, 44.1 або 48&nbsp;кГц. Завантажте на WeTransfer, Google Drive або Dropbox і вставте посилання — файл такого розміру не пройде як вкладення в листі.",
