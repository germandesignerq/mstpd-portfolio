...
(() => {
  ...
  const RU = {
    ...
    "svc.distro_label": "(06) — Дистрибуция",
    "svc.distro_title": "Сведено, отмастерено —<br>осталось выпустить.",
    "svc.distro": "Выпускаю за вас, в партнёрстве с <b>Believe</b>. Трек попадёт на все площадки, которые имеют значение, с мастерингом по стандарту и нормальной отчётностью.",
    "svc.distro_f1": "Партнёр Believe",
    "svc.distro_f2": "Apple Digital Masters",
    "svc.distro_f3": "Выплаты раз в квартал",
    "svc.distro_f4": "От $15 за сингл",
    "svc.distro_cta": "Условия дистрибуции",
    // presets page
    "pre.label": "Пресеты",
    ...
    "d.artist_hint": "Полное имя, под которым зарегистрирован каждый артист.",
    "d.artist_add": "Добавить артиста",
    ...
    "d.snippet": "Старт для TikTok / Instagram",
    "d.snippet_ph": "0:45",
    "d.snippet_hint": "С какой секунды играет отрывок в TikTok и Reels — мм:сс или просто секунды.",
    ...
    "d.audio": "Аудио трека",
    "d.audio_hint": "WAV, 16 или 24 бит, 44.1 или 48&nbsp;кГц — то, что просят площадки; здесь не проверяется.",
    "d.audio_uploading": "загружается…",
    "d.audio_upload_failed": "Не удалось загрузить — прикрепите файл ещё раз.",
    ...
    "js.captcha": "Подтвердите, что вы не робот.",
    "js.opening_mail": "Открываю почтовый клиент…",
    "js.sending": "Отправляю…",
    "js.sent": "Отправлено — скоро отвечу.",
    "js.success_sub": "Пока вы ждёте, взгляните на мои работы.",
    "js.cant_send_direct": "Не удалось отправить. Напишите напрямую на offmstpd@gmail.com.",
    "js.file_too_large": "Файл слишком большой для этого сервера — попробуйте файл поменьше.",
  ...
  const UK = {
    ...
    "svc.distro_label": "(06) — Дистрибуція",
    "svc.distro_title": "Зведено, відмастерено —<br>лишилося випустити.",
    "svc.distro": "Випускаю за вас, у партнерстві з <b>Believe</b>. Трек потрапить на всі майданчики, що мають значення, з мастерингом за стандартом і нормальною звітністю.",
    "svc.distro_f1": "Партнер Believe",
    "svc.distro_f2": "Apple Digital Masters",
    "svc.distro_f3": "Виплати раз на квартал",
    "svc.distro_f4": "Від $15 за сингл",
    "svc.distro_cta": "Умови дистрибуції",
    "pre.label": "Пресети",
    ...
    "d.artist_hint": "Повне ім'я, під яким зареєстрований кожен артист.",
    "d.artist_add": "Додати артиста",
    ...
    "d.snippet": "Старт для TikTok / Instagram",
    "d.snippet_ph": "0:45",
    "d.snippet_hint": "З якої секунди грає уривок у TikTok і Reels — хв:сс або просто секунди.",
    ...
    "d.audio": "Аудіо треку",
    "d.audio_hint": "WAV, 16 або 24 біт, 44.1 або 48&nbsp;кГц — те, що просять майданчики; тут не перевіряється.",
    "d.audio_uploading": "завантажується…",
    "d.audio_upload_failed": "Не вдалося завантажити — прикріпіть файл ще раз.",
    ...
    "js.captcha": "Підтвердіть, що ви не робот.",
    "js.opening_mail": "Відкриваю поштовий клієнт…",
    "js.sending": "Надсилаю…",
    "js.sent": "Надіслано — скоро відповім.",
    "js.success_sub": "Поки чекаєте, погляньте на мої роботи.",
    "js.cant_send_direct": "Не вдалося надіслати. Напишіть напряму на offmstpd@gmail.com.",
    "js.file_too_large": "Файл завеликий для цього сервера — спробуйте файл менше.",
