...
(() => {
  ...
  const RU = {
    ...
    "svc.distro": "Сведено и отмастерено — осталось выпустить. Дистрибуцией занимаюсь тоже, в партнёрстве с <b>Believe</b>: релиз попадёт в Spotify, Apple Music и на остальные площадки, с Apple Digital Masters, анимированными обложками и выплатами раз в квартал. От $15 за сингл.",
  ...
  const UK = {
    ...
    "svc.distro": "Зведено та відмастерено — лишилося випустити. Дистрибуцією займаюся теж, у партнерстві з <b>Believe</b>: реліз потрапить у Spotify, Apple Music та на інші майданчики, з Apple Digital Masters, анімованими обкладинками та виплатами раз на квартал. Від $15 за сингл.",
